    ...
    return (
        <div className="card bg-stone-200 rounded-md min-h-0 min-w-0 transition-transform duration-300 hover:scale-102">
            <div className="relative w-full h-full">
                {state.opened && (
                    <div className="w-[80%] h-[80%] rounded-br-full glass absolute big-text text-slate-200 pl-3">
                ...
                <div className="fixed left-0 right-0 top-0 bottom-0 flex justify-center items-center z-20 glass-2 animate-fadeIn">
                    <div className=" bgi relative overflow-hidden bg-slate-300 rounded-md pointer-events-auto describe bg-slate-300settings w-[max(85%,18rem)] max-h-[90vh] overflow-y-auto p-4 flex flex-col md:flex-row animate-modalIn">
                        ...
                        <div className="w-full py-1 flex flex-col justify-between items-center">
                            ...
                            <div className=" mt-3 pb-3 w-[30%] h-[30%]">
                                <div className="mb-8 bg-slate-400 w-full h-full aspect-square-j rounded-full big-text text-center font-extrabold border-0 border-slate-200 flex justify-center items-center">
                                    <span>
                                        {state.number}
                                    </span>
                                </div>
