    ...
    return (
        <div className=" relative card bg-stone-200 rounded-md min-h-0 min-w-0 transition-transform duration-300 hover:scale-102">
            ...
            <div className={` describe ${state.show ? " show " : ""} transition-all duration-500  z-20 glass-2 overflow-y-hidden`}>
                <div className={` bgi relative bg-slate-300 pointer-events-auto md:overflow-y-hidden overflow-y-auto`}>
                    ...
                    <div className={`${showText ? " opacity-100" : " opacity-0"} md:overflow-y-auto transition-all duration-300 h-full w-full py-1 flex flex-col justify-start items-center `}>
