  ...
  return (
    <div className=' app bg-slate-100'>
      <div className="main px-2 pt-3">
        <h1 className=' w-full text-center text-3xl mb-1 font-medium'>{data.title}</h1>
        {/* <h2 className=' w-full text-center text-lg mb-1'>{data.subtitle}</h2> */}
      </div>
      <div className={` px-3 cards g-${settings.grid} i-${settings.aspectRatio} s-${settings.size} mb-4`}>
